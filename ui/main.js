...
$('aboutBtn').addEventListener('click', () => {
  openModal(`
    ...
    <div class="mbody" style="text-align:center">
      <img src="logo2-ui.png" alt="Ralle's Texture Swapper" style="width:min(420px,80%);border-radius:14px;margin:6px 0 14px">
      <p style="font-size:15px;font-weight:650">Ralle's Texture Swapper</p>
